...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
          ...
          <div className="text-center">
            ...
            <div className="mt-16 sm:mt-20 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-2xl mx-auto">
              ...
              <div className="text-center">
                ...
                <div className="mt-1 text-sm text-slate-400">Calendriers illimités</div>
              </div>
              <div className="text-center">
                <div className="text-3xl sm:text-4xl font-bold text-white">24/7</div>
                <div className="mt-1 text-sm text-slate-400">Accès mobile</div>
              </div>
            </div>
          </div>
              ...
              >
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold text-white mb-4">{tab.label}</h3>
                  ...
                  <div className="hidden md:block">
                    <div className="rounded-xl border border-slate-700 bg-slate-900/80 p-6 aspect-video flex items-center justify-center">
      ...
      <section className="py-24 bg-slate-900/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 lg:gap-8">
            {/* Google */}
            <div className="flex items-center gap-3 rounded-xl border border-slate-800 bg-slate-900/50 px-6 py-4 hover:border-slate-700 transition-colors">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-slate-800 bg-gradient-to-br from-slate-900 to-slate-900/50 p-8 md:p-12 text-center">
